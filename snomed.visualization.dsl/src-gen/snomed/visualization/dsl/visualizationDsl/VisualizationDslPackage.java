...
public interface VisualizationDslPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Standalone Relationships</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPRESSION__STANDALONE_RELATIONSHIPS = 1;

  /**
   * The feature id for the '<em><b>Relationship Groups</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXPRESSION__RELATIONSHIP_GROUPS = 2;
  ...
  /**
   * Returns the meta object for the containment reference '{@link snomed.visualization.dsl.visualizationDsl.Expression#getStandaloneRelationships <em>Standalone Relationships</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Standalone Relationships</em>'.
   * @see snomed.visualization.dsl.visualizationDsl.Expression#getStandaloneRelationships()
   * @see #getExpression()
   * @generated
   */
  EReference getExpression_StandaloneRelationships();

  /**
   * Returns the meta object for the containment reference list '{@link snomed.visualization.dsl.visualizationDsl.Expression#getRelationshipGroups <em>Relationship Groups</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Relationship Groups</em>'.
   * @see snomed.visualization.dsl.visualizationDsl.Expression#getRelationshipGroups()
   * @see #getExpression()
   * @generated
   */
  EReference getExpression_RelationshipGroups();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Standalone Relationships</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference EXPRESSION__STANDALONE_RELATIONSHIPS = eINSTANCE.getExpression_StandaloneRelationships();

    /**
     * The meta object literal for the '<em><b>Relationship Groups</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference EXPRESSION__RELATIONSHIP_GROUPS = eINSTANCE.getExpression_RelationshipGroups();
